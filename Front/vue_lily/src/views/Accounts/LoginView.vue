<script setup>
    import { DOMAIN_NAME } from '@/api_links.js';
    ...
    function sendLoginDataToAPI(){
        axios.post(URL_LOGIN_API, {
            ...
            response =>{
                localStorage.setItem('AccsessToken', response.data.accsess);
    ...
    // {% if msg_superuser %}
    //     <h1>You are login with stuff account please go to <a href="/admin" target="_blank">admin page</a></h1>
    // {% endif %}
</script>
