...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\MyCodingJourney\DRF_Vue.js\la_fleur_lily\Back\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\MyCodingJourney\DRF_Vue.js\la_fleur_lily\Back\venv\Scripts\deactivate.nu'
